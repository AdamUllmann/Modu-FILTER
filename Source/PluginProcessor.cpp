...
//==============================================================================
ModuFilterAudioProcessor::ModuFilterAudioProcessor()
...
//==============================================================================
const juce::String ModuFilterAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool ModuFilterAudioProcessor::acceptsMidi() const
{
...
bool ModuFilterAudioProcessor::producesMidi() const
{
...
bool ModuFilterAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double ModuFilterAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int ModuFilterAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int ModuFilterAudioProcessor::getCurrentProgram()
{
    return 0;
}

void ModuFilterAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String ModuFilterAudioProcessor::getProgramName (int index)
{
    return {};
}

void ModuFilterAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void ModuFilterAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool ModuFilterAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void ModuFilterAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool ModuFilterAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* ModuFilterAudioProcessor::createEditor()
{
    return new ModuFilterAudioProcessorEditor (*this);
}

//==============================================================================
void ModuFilterAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
